...
/**
 * Listens to the "flashsale.purchase.completed" Redis Stream and updates inventory. Consumer group
 * guarantees at-least-once delivery; idempotency is enforced in {@link
 * InventoryService#handlePurchase} via the processed_orders table.
 */
@Component
@Slf4j
