...
public class FlashSaleController {
    ...
    @GetMapping("/active")
    @Operation(summary = "Get active flash sale products", description = "Returns all products currently on flash sale")
    public ResponseEntity<List<FlashSaleProductResponse>> getActiveProducts() {
        List<FlashSaleProductResponse> products = flashSalePort.getActiveFlashSaleProducts()
                .stream()
    ...
    @Operation(summary = "Purchase a flash sale product",
            description = "Purchase a product during an active flash sale. Each user can only purchase 1 product per day.",
