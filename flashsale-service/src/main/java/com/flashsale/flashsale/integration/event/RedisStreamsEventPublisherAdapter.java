...
/**
 * Publishes domain events to Redis Streams so the inventory-service
 * can consume them asynchronously and update stock levels.
 */
@Primary
@Component
@Slf4j
    ...
    public void publish(String topic, Object payload) {
        try {
            ...
            redisTemplate.opsForStream().add(
                    MapRecord.create(topic, Map.of("payload", json)));
