...
public class AuthService implements AuthPort {
    ...
    public void verifyOTP(UUID userId, String otp) {
        OtpToken otpToken = otpRepository.findLatestUnusedByUserId(userId)
    ...
    public String login(LoginCommand command) {
        ...
        if (!user.isVerified()) {
            throw new IllegalStateException("Acccount is not verified; Please verify email or phone first");
        }
