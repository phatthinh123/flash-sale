...
@Tag(name = "Authentication", description = "User registration, login, OTP verification, and logout")
public class AuthController {
    ...
    @Operation(summary = "Register a new user", description = "Register with email or phone number. An OTP will be sent for verification.")
    ...
    @PostMapping("/login")
    @Operation(summary = "Login", description = "Login with email/phone and password. Returns JWT token.")
